...
tr::ExpAndTy *OpExp::Translate(env::VEnvPtr venv, env::TEnvPtr tenv,
  ...
  auto right_exp_ty = right_->Translate(venv,tenv,level,label,errormsg);
  {
    ...
    switch (oper_)
    {
    case absyn::PLUS_OP:op = tree::PLUS_OP;break;
    case absyn::MINUS_OP:op = tree::MINUS_OP;break;
    case absyn::TIMES_OP:op = tree::MUL_OP;break;
    case absyn::DIVIDE_OP:op = tree::DIV_OP;break;
    default:
      break;
    }
...

  {
    ...
    switch (oper_)
    {
    case absyn::LT_OP:op = tree::LT_OP;break;
    case absyn::LE_OP:op = tree::LE_OP;break;
    case absyn::GT_OP:op = tree::GT_OP;break;
    case absyn::GE_OP:op = tree::GE_OP;break;
    default:
      break;
    }
...

  {
    ...
    switch (oper_)
    {
    case absyn::EQ_OP:op = tree::EQ_OP;break;
    case absyn::NEQ_OP:op = tree::NE_OP;break;
    default:
      break;
    }
    if(op != tree::REL_OPER_COUNT){
